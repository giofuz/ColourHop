...
var i = ["blueEmitter", "purpleEmitter", "yellowEmitter","greenEmitter"];
...
preload.prototype = {
    preload: function() {
        ...
        //Emitter
        game.load.image("purpleEmitter", "assets/sprites/purpleEmitter.png", 32, 32);
        game.load.image("yellowEmitter", "assets/sprites/yellowEmitter.png", 32, 32);
        game.load.image("greenEmitter", "assets/sprites/greenEmitter.png", 32, 32);
        game.load.image("blueEmitter", "assets/sprites/blueEmitter.png", 32, 32);
        //Trophy
        ...
        game.load.image('spaceBar', 'assets/sprites/spaceBar2.png');
...
titleScreen.prototype = { 
    create: function() {
        ...
        var start = game.add.image(50, 500, 'tap');
        var start2 = game.add.image(100, 545, 'spaceBar');
...
playGame.prototype = {
    create: function() {
        ...
        keys.space.onDown.add(this.jump, this);    
    ...
    update: function() {
        ...
        if (this.blueBall.y < 0 || this.blueBall.y > 800){
            this.restartGame();
        }  
        ...
        this.blueBall, this.yellowBlock, this.expolsion, null, this);

        game.physics.arcade.overlap(
        this.blueBall, this.greenBlock, this.expolsion, null, this);

        game.physics.arcade.overlap(
        this.blueBall, this.purpleBlock, this.expolsion, null, this);
        ...
        game.physics.arcade.overlap(
        this.purpleBall, this.yellowBlock, this.expolsion, null, this);

        game.physics.arcade.overlap(
        this.purpleBall, this.greenBlock, this.expolsion, null, this);

        game.physics.arcade.overlap(
        this.purpleBall, this.blueBlock, this.expolsion, null, this);
        ...
        game.physics.arcade.overlap(
        this.yellowBall, this.blueBlock, this.expolsion, null, this);

        game.physics.arcade.overlap(
        this.yellowBall, this.greenBlock, this.expolsion, null, this);

        game.physics.arcade.overlap(
        this.yellowBall, this.purpleBlock, this.expolsion, null, this);
        ...
        game.physics.arcade.overlap(
        this.greenBall, this.yellowBlock, this.expolsion, null, this);

        game.physics.arcade.overlap(
        this.greenBall, this.purpleBlock, this.expolsion, null, this);

        game.physics.arcade.overlap(
        this.greenBall, this.blueBlock, this.expolsion, null, this);
   ...
   // },
    ...
    particleBurst: function() {
        ...
        emitter.x = this.game.world.width/2+20;
        emitter.y = this.game.world.height/2-100;
        emitter.makeParticles(i[emitCount]);
