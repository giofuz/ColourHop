...
var wheel, rewind;
var cursors;
var colors,bricks,brick,markerBrick;
var i = 0;
var p = null;
var score = 0;
var scoreText, text;
...
playGame.prototype = {
    create: function() {
        ...
        //time_til_spawn = Math.random()+ 1000;  //Random time between 2 and 5 seconds.
    ...
    update: function() {
        ...
        //bricks.setAll('x', -2, true, true, 1);
        //bricks.forEach(this.checkBrick, this, true);
        
//        var current_time = game.time.time;
//        if(current_time - last_spawn_time > time_til_spawn){
//            time_til_spawn = Math.random() + 1000;
...
//        }
        ...
        this.purpleBall, this.purpleBlock, this.restartGame, null, this);
...
//        
//        var i = ["yellowBlock", "greenBlock", "purpleBlock","blueBlock"];
//        this.brick = bricks.create(game.world.width, game.world.height/2, i[Math.floor(Math.random() * 4) + 0]);
//        game.physics.arcade.enable(this.brick);
//
//        console.log(bricks.children[count].key)
//    },
